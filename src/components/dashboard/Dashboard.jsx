          ...
          <>
            <div className="signlang_header-data">
              ...
              <div className="signlang_leader-board">
                <h2 className="gradient__text title">Топ користувачів</h2>
            ...
            <div className="signlang_dashboard-midsection">
              <div className="signlang_sign-table">
                <h2 className="gradient__text">Жести, що практикуються Вами найчастіше</h2>

                <table>
                  <tr>
                    <th className="table-heading">№</th>
                    <th className="table-heading">Жест</th>
                    <th className="table-heading">Частота</th>
                  </tr>
              ...
              <div className="signlang_quotes-box">
                <h2 className="gradient__text">Важливо знати</h2>
                <div>
